...
public:
	...
	Neuron(int n_factors, int layer, float *weights, bool sigmoid,
		   float midpoint);
	Neuron(int n_factors, int layer, bool rand, int seed, bool sigmoid,
		   float midpoint);
